...
if (isset($_POST['signup'])) {
	...
	if (!$error) {
		if(mysqli_query($con, "INSERT INTO admin(name,email,password,dob,type) VALUES('" . $name . "', '" . $email . "', '" . md5($password) . "', '" .$dob . "', '" .$type . "')")) {
...
<div class="container">
		...
		<div class="col-md-4 col-md-offset-4 well">
			<form role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="signupform">
				<fieldset>
                    ...
                    <br>
                    <div class="form-group">
                    <label for="name">Privileges of User--- </label>
						<select name="type">
	...
	<div class="row">
		...
		Check Users <a href="users.php">Here</a>
		</div>
	</div>
</div>
