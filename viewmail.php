    ...
    <div id="container">
    	<div class="sidebar">
        	<ul id = "nav">
                    ...
                    <li><a class="selected" href="#">Check Mail</a></li>
        ...
        <div class="content">
        	<h2>Dashboard</h2>
             ...
             <div id="box">
            	<div class="box-top">Mailing Section</div>
                <div class="box-panel" style="overflow:scroll; height: 520px;">
                	<?php
					if(($_SESSION['usr_type']) != "G") {
						$result = mysqli_query($con, "SELECT * FROM admin_mail order by id DESC");
					}
					if ($result->num_rows > 0) {
						while($row = $result->fetch_assoc()) {
							echo "User : " . $row["user"]. "<br>Email of Reciever : " . $row["reciver"]. "<br>Subject : " . $row["subject"]. " <br><br>Content : " . $row["content"]. " <br><hr>"; }
					} else {
