    ...
    <div id="container">
    	<div class="sidebar">
        	<ul id = "nav">
                    ...
                    <li><a href="#">Check Users Login</a></li>
                    <?php } ?>
                    <li><a class="selected" href="memo.php">Create a New MEMO </a></li>
        ...
        <div class="content">
        	<h2>Dashboard</h2>
             ...
             <div id="box">
            	<div class="box-top">Users List</div>
                <div class="box-panel" style="overflow:scroll; height: 520px;">
					...
					if ($result->num_rows > 0) {
						while($row = $result->fetch_assoc()) {
							echo "Username : " . $row["name"]. "<br>Email : " . $row["email"]. "<br><hr>"; }
					} else {
